...
public class CollectionArticleFragment extends BaseFragment {
    ...
    private ArrayList<CollectionSqlDataBean> arrayList;  // 装载 ListView 显示的数据集合
    ...
    private void showCollectionArticle() {
        dbTool.queryAllData(CollectionSqlDataBean.class, new DBTool.OnQueryListener<CollectionSqlDataBean>() {
            @Override
            public void onQuery(final ArrayList<CollectionSqlDataBean> collectionSqlDatas) {
